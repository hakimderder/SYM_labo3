...
public class NFCUtils {
    ...
    private static final String[] nfcValues = {"test", "1 2 3 4", "é è ê ë ē ė ę ě ĕ ə", "♤ ♡ ♢ ♧"};
    private Handler handler;

    NFCUtils(Intent intent, Handler handler){
    ...
    public static boolean checkNfcValues(ArrayList<String> values){
        for(String s : values){
            for(String s1 : nfcValues){
                if(s.equals(s1)){
                    return true;
                }
            }
